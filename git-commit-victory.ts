...
console.log("=== Staging BattleScene Changes ===");
run('git add src/screens/BattleScene.tsx');

console.log("=== Committing Casualty-Casual Victory Formula ===");
const commitMsg = "fix: override stage win conditions to award victory if player sustained fewer casualties";
...
try {
  fs.unlinkSync('git-commit-victory.ts');
